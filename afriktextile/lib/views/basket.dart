...
var idCommand =
    "${randomAlphaNumeric(10)}AFRIKTEXTILE${randomBetween(100, 20000)}";
                                            ...
                                            children: <Widget>[
                                              Container(
                                                ...
                                                child: CachedNetworkImage(
                                                  imageUrl:
                                                      "http://afriktextile.com/app/aftxl/requests/getImage.php?id_prod=${snapshot.data[index].prodId}&id_im=${snapshot.data[index].image}",
                          ...
                          pds.then((dt) {
                            if (dt.length != 0) {
                              Navigator.pushAndRemoveUntil(
                                context,
                                MaterialPageRoute(
                                    builder: (context) => PayementDetail()),
                                ModalRoute.withName('/'),
                              );
                            } else {
                              Fluttertoast.showToast(
                                  msg:
                                      'Opération Impossible car votre panier est vide.',
